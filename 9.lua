...
function lib:Window(p)
    if rcm.win then return rcm.win end
...
function lib:Page(name)
    if not rcm.win then return nil end
    return rcm.win:Page(name)
end

function lib:input()
    if rcm.win then rcm.win:input() end
end

function lib:draw()
    if rcm.win then rcm.win:draw() end
end
