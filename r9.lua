...
if not _G.__rcm then
    _G.__rcm = {win = nil, theme = {
        inline = {6,6,6},
        dark = {24,24,24},
        text = {255,255,255},
        accent = {205,0,127},
...
function lib:Window(p)
    if _G.__rcm.win then return _G.__rcm.win end
...
function lib:Page(name)
    if not _G.__rcm.win then return nil end
    return _G.__rcm.win:Page(name)
end

function lib:rebuild()
    if _G.__rcm.win then _G.__rcm.win:rebuild() end
end

function lib:input()
    if _G.__rcm.win then _G.__rcm.win:input() end
end

function lib:draw()
    if _G.__rcm.win then _G.__rcm.win:draw() end
end
